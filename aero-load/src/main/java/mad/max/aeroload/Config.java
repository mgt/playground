...
public class Config {
    ...
    public AerospikeClient aerospikeClient(@Value("${job.profile}") JobProfile.PredefinedProfiles predefinedProfiles) {
        ...
        eventPolicy.maxCommandsInProcess = predefinedProfiles.getProfile().getMaxParallelCommands();
        ...
        eventPolicy.maxCommandsInQueue = predefinedProfiles.getProfile().getMaxParallelCommands();
