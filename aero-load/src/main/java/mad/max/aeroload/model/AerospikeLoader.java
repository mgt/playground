...
public class AerospikeLoader extends Consumer<Product<Key, Operation[]>>  {
	...
	private static class AerospikeLoadingMetrics {
		private final java.text.SimpleDateFormat SimpleDateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		AtomicInteger writeQueuedCount = new AtomicInteger();
		AtomicInteger writeProcessingCount = new AtomicInteger();
		AtomicInteger writeCompletedCount = new AtomicInteger();
		...
		AtomicInteger writeHotKey = new AtomicInteger();
		AtomicInteger writeDeviceOverload = new AtomicInteger();
		AtomicLong writeBestTime = new AtomicLong();
		AtomicLong writeWorstTime = new AtomicLong();
		...
		public String getStats(){
			...
			return String.format("StartedAt:%s processed=%d inProgress=%d queued=%d t=%d tps=%f " +
					...
					getCurrentThroughput(), tps,  this.writeErrors.get(), this.writeTimeouts.get(),
					this.writeKeyExists.get(), this.writeHotKey.get(), this.writeDeviceOverload.get());
		}
